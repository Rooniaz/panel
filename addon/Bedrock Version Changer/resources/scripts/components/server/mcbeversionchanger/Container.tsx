...
export default () => {
    ...
    return (
        <ServerContentBlock 
            title={'Minecraft Bedrock Version Manager'}
            showFlashKey='mcbe:version'
        >
            <FlashMessageRender />
            ...
            <div className="mb-4">
                <Alert type="info">
                    <div className="flex items-center">
                        <p>
                            Make sure to backup your data before changing versions.
                            Some versions might not be compatible with your current world data.
                        </p>
                    </div>
                </Alert>
            </div>
                            ...
                            <div className="flex items-center">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm text-neutral-300">
                                        {majorVersion.versions.length} version{majorVersion.versions.length !== 1 ? 's' : ''} available
                                    </p>
                                </div>
