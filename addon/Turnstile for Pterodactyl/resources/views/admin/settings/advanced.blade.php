                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <select class="form-control" name="recaptcha:enabled">
                                        ...
                                        <option value="true" @if(old('recaptcha:enabled', config('recaptcha.enabled')) == '1') selected @endif>reCAPTCHA</option>
                                        <option value="turnstile" @if(old('recaptcha:enabled', config('recaptcha.enabled')) == 'turnstile') selected @endif>Cloudflare Turnstile</option>
                                    </select>
                                    <p class="text-muted small">If enabled, login forms and password reset forms will require captcha verification.</p>
                                </div>
                            </div>
                            <div class="form-group col-md-4">
